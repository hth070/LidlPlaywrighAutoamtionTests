...
*/
        ...
        try {
            ...
            await expect(page.locator('.s-page-heading__text')).toHaveText('8147 produktov');
        } catch (error) {
    ...
    try {
        ...
        // Verify Značka subfacet list for 'LIVARNO home', 'PARKSIDE', 'esmara', 'CRIVIT', 'lupilu', 'ERNESTO', 'LIVERGY', '-', 'SILVERCREST KITCHEN TOOLS', 'Playtive'
